...
export const CURRICULUM: Record<string, Course[]> = {
  ...
  '7': [
    ...
    },
    {
      ...
      description: '',
      professors: ['Dr. Rudresh Acharya', 'Dr. Palok Aich'],
    },
    {
      code: 'B406',
  ...
  '8': [
    {
      ...
      description: '',
      professors: ['Dr. Badreenath Konkimala', 'Dr. Mohammed Saleem'],
    },
    {
      code: 'B407',
  ...
  'ADVANCE COURSES': [
    ...
    },
    {
      ...
      description: '',
      professors: ['Dr. Manjusha Dixit', 'Dr. Debasmiata P Alone'],
    },
    {
      code: 'BIO700',
